...
function Enquire() {
  ...
  return (
    <div className='Details'>
      <div className='Entry'>
        <h3>Enquire Now.</h3>
        <p><strong>Would you like to speak to one of our advisers over the phone? Just submit your details and we’ll be in touch shortly. You can also email us if you would prefer.</strong></p>
      </div>
      <div>
